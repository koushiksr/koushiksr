...
<p align="center">
  I am passionate about bridging the gap between artificial intelligence and scalable web applications. I specialize in developing machine learning solutions, integrating Large Language Models (LLMs), and architecting robust full-stack applications using the MERN stack. I love building intelligent, data-driven systems and creating custom modular tools from the ground up.
</p>
...
### 🔭 What I'm working on:
- Architecting and deploying **end-to-end AI solutions** and intelligent agents.
- Building scalable full-stack web applications utilizing the **MERN stack** (MongoDB, Express, React, Node.js).
- Exploring **Generative AI** architectures and integrating LLMs into production environments.
- Developing custom data-processing tools, APIs, and terminal-style interfaces using Python.
...
![](https://img.shields.io/badge/AI-Generative_AI-informational?style=flat&logo=GoogleGemini&color=8E75B2)
![](https://img.shields.io/badge/Data-Algorithms_%26_Stats-informational?style=flat&logo=Python&color=FFD43B)
